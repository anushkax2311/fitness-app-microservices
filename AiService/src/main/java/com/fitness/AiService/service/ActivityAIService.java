...
public class ActivityAIService {
	...
	private Recommendation processAiResponse(Activity activity, String aiResponse) {
		try {
			...
			return Recommendation.builder().activityId(activity.getId())
					...
					.improvements(improvements).suggestions(suggestions)
					.safety(safety).createdAt(LocalDateTime.now()).build();
	...
	private Recommendation createDefaultRecommendation(Activity activity) {
		return Recommendation.builder()
				...
				.safety(Arrays.asList("Always warm up before exercise",
						"Stay hydrated",
						"Listen to your body")).createdAt(LocalDateTime.now()).build();
	}
	...
	private String createPromptForActivity(Activity activity) {
		...
		return String.format("""
		        ...
		        """ , activity.getType(),activity.getDuration(),activity.getCaloriesBurned(),activity.getAdditionalMatrics());
	}
}
